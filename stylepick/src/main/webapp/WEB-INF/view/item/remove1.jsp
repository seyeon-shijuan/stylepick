...
<div style="text-align:right;" id="but_group">
<button onclick="javascript:deleteform.submit()" class="bttn-unite bttn-md bttn-primary">확인</button>
<button onclick="javascript:window.close()"  class="bttn-pill bttn-md bttn-primary">취소</button>
</div>
</form>
</div>
</body>
